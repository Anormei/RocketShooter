...
public class DrawUtils {
    ...
    public static void drawOverlay(GL11 gl, Sprite src, Sprite trgt){
    ...
    public static void drawOverlay(GL11 gl, Sprite src, List<?> trgt, SpriteBatcher batcher){
        ...
        List<Sprite> sprites = (List<Sprite>)trgt;

        if(sprites.size() > 0) {
            batcher.startBatch(sprites.get(0).texture);
    ...
    public static void drawTint(GL11 gl, Sprite trgt, float[] tint){
        colorBuffer.clear();
